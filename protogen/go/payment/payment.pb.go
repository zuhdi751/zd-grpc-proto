...
import (
	transaction "github.com/zuhdi751/zd-grpc-proto/protogen/go/transaction"
...
type PaymentRequest struct {
	...
	TotalAmount string            `protobuf:"bytes,3,opt,name=total_amount,proto3" json:"total_amount,omitempty"`
...
func (x *PaymentRequest) GetTotalAmount() string {
	if x != nil {
